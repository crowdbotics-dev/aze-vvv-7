"""
Django settings for aze_vvv_7 project.
...
WSGI_APPLICATION = 'aze_vvv_7.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aze_vvv_7 API",
    "DESCRIPTION": "API documentation for aze_vvv_7 App",
    "VERSION": "v1",
}
